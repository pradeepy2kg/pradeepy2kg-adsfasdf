...
public final class Permission {
    ...
    public static final int USER_PREFERENCES = 13;
    public static final int SEARCH_PRS = 14;
    public static final int SEARCH_BDF = 15;
    public static final int EDIT_BDF_CONFIRMATION = 16;
