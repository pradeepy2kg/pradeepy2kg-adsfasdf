...
public final class Permission {
    ...
    public static final int REGISTRAR_MANAGEMENT = 12;
    public static final int SERVICE_MASTER_DATA_MANAGEMENT = 13;
    public static final int USER_PREFERENCES = 14;
    public static final int SEARCH_PRS = 15;
    public static final int SEARCH_BDF = 16;
    public static final int EDIT_BDF_CONFIRMATION = 17;
