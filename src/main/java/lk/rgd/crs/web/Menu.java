...
public class Menu {
    ...
    static {
        ...
        adminLink.put("eprInitDivisionList.do", new Link(null, "/ecivil/management/", "eprInitDivisionList.do", Permission.SERVICE_MASTER_DATA_MANAGEMENT));
         // TODO temp permission to re-arrange divisions
        adminLink.put("eprInitRearrangeDivision.do", new Link(null, "/ecivil/management/", "eprInitRearrangeDivision.do", Permission.SERVICE_MASTER_DATA_MANAGEMENT));
        adminLink.put("eprRearrangeDivision.do", new Link(null, "/ecivil/management/", "eprRearrangeDivision.do", Permission.SERVICE_MASTER_DATA_MANAGEMENT));
        ...
        adminLink.put("eprRegistrarDelete.do", new Link("search.registrar", "/ecivil/management/", "eprRegistrarDelete.do", Permission.REGISTRAR_DELETE));
        ...
        adminLink.put("eprInitZonalOffices.do", new Link("manageZonalOffices.label", "/ecivil/management/", "eprInitZonalOffices.do", Permission.SERVICE_MASTER_DATA_MANAGEMENT));
        adminLink.put("eprManageZonalOffices.do", new Link(null, "/ecivil/management/", "eprManageZonalOffices.do", Permission.SERVICE_MASTER_DATA_MANAGEMENT));
        ...
        searchLink.put("eprBirthsRejectedSearch.do", new Link("birth.rejectedSearch.label", "/ecivil/births/", "eprBirthsRejectedSearch.do", Permission.SEARCH_BDF));
        searchLink.put("eprDeathsRejectedSearch.do", new Link("death.rejectedSearch.label", "/ecivil/deaths/", "eprDeathsRejectedSearch.do", Permission.SEARCH_DDF));
        ...
        adrPRSLink.put("eprEditPersonDetails.do", new Link(null, "/ecivil/prs/", "eprEditPersonDetails.do", Permission.PRS_EDIT_PERSON));
        adrPRSLink.put("eprUpdatePersonDetails.do", new Link(null, "/ecivil/prs/", "eprUpdatePersonDetails.do", Permission.PRS_APPROVE_EDIT_PERSON));
        ...
        deoAlterationLink.put("eprPopulateAdoptionAlterationForEdit.do", new Link(null, "/ecivil/alteration/", "eprPopulateAdoptionAlterationForEdit.do", Permission.EDIT_ADOPTION_ALTERATION));
        ...
        adrAlterationLink.put("eprLoadAdoptionAlterationForApprove.do", new Link(null, "/ecivil/alteration/", "eprLoadAdoptionAlterationForApprove.do", Permission.APPROVE_ADOPTION_ALTERATION));
        adrAlterationLink.put("eprApproveAdoptionAlteration.do", new Link(null, "/ecivil/alteration/", "eprApproveAdoptionAlteration.do", Permission.APPROVE_ADOPTION_ALTERATION));
        ...
        deoMarriageLink.put("eprMarriageNoticeSearchHome.do", new Link(null, "/ecivil/marriages/", "eprMarriageNoticeSearchHome.do", Permission.EDIT_MARRIAGE));
        ...
        adrMarriageLink.put("eprBackMarriageRegisterSearch.do", new Link(null, "/ecivil/marriages/", "eprBackMarriageRegisterSearch.do", Permission.APPROVE_MARRIAGE));
