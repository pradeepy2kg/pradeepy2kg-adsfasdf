...
public class Menu {
    ...
    static {
        ...
        * */
        ...
        deoMarriageLink.put("eprMarriageNoticeSearchInit.do", new Link("menu.marriage.notice.search", "/ecivil/marriages/", "eprMarriageNoticeSearchInit.do", Permission.EDIT_MARRIAGE));
