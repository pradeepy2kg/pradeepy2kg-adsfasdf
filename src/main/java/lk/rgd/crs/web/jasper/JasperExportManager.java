...
public class JasperExportManager {
    ...
    public static void exportReportToHtmlFileIncludeExternalScript(JasperPrint jasperPrint,
                                                                   String destFileName, String scriptExternal) throws JRException {
        System.out.println("exportReportToHtmlFileIncludeExternalScript@JasperExportManagerCalled");
        JRHtmlExporter exporter = new JRHtmlExporter();
     ...
     // test
       ...
       */
        exporter.exportReportIncludeExternalScript(scriptExternal);
