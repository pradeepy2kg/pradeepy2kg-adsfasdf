...
public class JRHtmlExporter extends JRAbstractExporter {
    ...
    * */
    ...
    public static String EXTERNAL_SCRIPT = null;
    ...
    /*customize method to include a external CSS
   * updated by amith
   * */
    public void exportReportIncludeExternalScript(String script) {
        System.out.println("exportReportIncludeExternalScript@JRHtmlExporterCalled");
    ...
    public void exportReport() throws JRException {
        /**
         * this code change by amith
         */

        System.out.println(" exportReport@JRHtmlExporteCalled");
    ...
    /**
     * things to do  include external script string to the write object
     */
    protected void exportReportToWriter() throws JRException, IOException {
        System.out.println("exportReportToWriter@JRHtmlExporterCalled");
        if (htmlHeader == null) {
...
//			writer.write("<html xmlns=\"http://www.w3.org/1999/xhtml\">\n");
            ...
            writer.write("  </style>\n");
            //    writer.write("<link type=\"text/css\" rel=\"stylesheet\" herf="+EXTERNAL_SCRIPT+" />");
            //     writer.write("<script type=\"text/javascript\">");
            //     writer.write("alert('amith did it')");
            //     writer.write("</script>");
            writer.write("</head>\n");
            ...
            writer.write("\n");
            //  writer.write("<link type=\"text/css\" rel=\"stylesheet\" herf="+EXTERNAL_SCRIPT+" />");
            //  writer.write("<div id=\"for-print\">This is for printing.</div>");
        } else {
