...
public class RedirectMessageInterceptor extends MethodFilterInterceptor {
    ...
    private static final Logger logger = LoggerFactory.getLogger(RedirectMessageInterceptor.class);
    ...
    public String doIntercept(ActionInvocation invocation) throws Exception {
        logger.debug("redirect interceptor invoked for action : {}", invocation.getAction());
