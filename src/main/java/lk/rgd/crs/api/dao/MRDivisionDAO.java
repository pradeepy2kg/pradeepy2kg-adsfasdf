...
public interface MRDivisionDAO {
    ...
    /**
     * Return the list of MR Division by DS Division and MR Division id/code
     *
     * @param mrDivisionId the MR Division id/code
     * @param dsDivision   the DS Division
     * @return the list of matching MR Divisions
     */
    public List<MRDivision> getMRDivisionByCode(int mrDivisionId, DSDivision dsDivision);

    /**
     * Return the list of MR Divisions by DS Division unique key and MR Division name in any language
     *
     * @param mrDivision     the MR Division
     * @param dsDivisionUKey the DS Division unique key
     * @return the list of matching MR Divisions
     */
