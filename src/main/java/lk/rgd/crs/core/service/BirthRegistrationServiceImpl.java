...
public class BirthRegistrationServiceImpl implements
    ...
    public BirthRegistrationServiceImpl(
        ...
        BirthRecordsIndexer birthRecordsIndexer, CertificateSearchDAO certificateSearchDAO, AdoptionOrderDAO adoptionOrderDAO,
    ...
    public List<BirthDeclaration> performBirthCertificateSearch(CertificateSearch cs, User user) {
        ...
        if (certificate.getApplicationNo() != null && certificate.getDsDivision() != null) {
            existing = certificateSearchDAO.getByDSDivisionAndSerialNo(certificate.getDsDivision(), certificate.getApplicationNo());
        }
        ...
        if (existing == null) {
            ...
            certificateSearchDAO.addBirthCertificateSearch(cs);
