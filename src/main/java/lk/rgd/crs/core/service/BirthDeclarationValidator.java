...
public class BirthDeclarationValidator {
    ...
    public void validateMinimalRequirements(BirthDeclaration bdf) {
        ...
        if (bdf.getRegister().getDateOfRegistration() == null ||
                ...
                isEmptyString(bdf.getNotifyingAuthority().getNotifyingAuthorityPIN()) || validateBirthPlace(bdf)) {
    ...
    public boolean validateBirthPlace(BirthDeclaration bdf) {
        if (bdf.getChild().getBirthAtHospital()) {
            if (bdf.getChild().getBirthHospital().getHospitalUKey() == 0) {
                return true;
            } else {
                bdf.getChild().setPlaceOfBirth(null);
                return false;
            }
        } else {
            bdf.getChild().setBirthHospital(null);
            return isEmptyString(bdf.getChild().getPlaceOfBirth());
        }
