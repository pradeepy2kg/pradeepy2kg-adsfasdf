...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		...
		prevLinkText: 'Prev',
		doneButtonText: 'Done',
		earliestDate: Date.parse('-99years'), //earliest date allowed
	...
	function fDate(date){
	   if(date == null || !date.getDate()){return '';}  // asankha bug fix for null check
	...
	function showRP(){
		if(rp.data('state') == 'closed'){ 
			rp.data('state', 'open');
            // next 4 lines - bug fix by asankha as per http://www.filamentgroup.com/lab/date_range_picker_using_jquery_ui_16_and_jquery_ui_css_framework/
