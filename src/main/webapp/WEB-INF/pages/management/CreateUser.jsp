...
function validate() {
    ...
    var out = checkActiveFieldsForSyntaxErrors('create-user-form');
    if (out != "") {
...
<s:form id="create-user-form" name="userCreationForm" action="eprUserCreation" method="POST"
...
<table class="user-create-table" cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <td>
            <s:textarea name="user.sienSignatureText" id="sienSignatureText"
    ...
    <tr>
        ...
        <td>
            <s:textarea name="user.taenSignatureText" id="taenSignatureText"
                        cssStyle="text-transform:capitalize;width:90%;margin-left:0;" rows="3"/>
        </td>
        <td>
