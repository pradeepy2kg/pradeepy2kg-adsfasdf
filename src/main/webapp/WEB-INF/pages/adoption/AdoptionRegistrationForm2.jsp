...
<div id="adoption-registration-form-outer">
    ...
    <table class="adoption-reg-form-02-table01" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td colspan="2"><sx:datetimepicker id="bdayDatePicker" name="" displayFormat="yyyy-MM-dd"
        ...
        <tr>
            ...
            <td colspan="4"><textarea id="" name=""></textarea></td>
        </tr>
        <tr>
            <td>ලබා දෙන නම <br/>
                New name given
    ...
    <table style="width:1030px; text-align:center;border:none;margin-bottom:20px;">
        <tr>
