...
<div id="birth-register-approval">
    <div id="birth-register-approval-header">
        <s:form action="eprFilterBirthConfirmPrint.do" name="birth_register_approval_head" method="POST">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <s:radio name="selectOption" value="#session.Printed" list="#@java.util.HashMap@{'Not Printed':'Not Printed'}"/> &nbsp;&nbsp;&nbsp;
            <s:radio name="selectOption" value="#session.Printed" list="#@java.util.HashMap@{'Printed':'Printed'}"/> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div id="birth-register-approval-body">
        <s:form name="birth_confirm_print" action="" method="POST">
            ...
            <s:label><span><s:label name="print_selected" value="%{getText('print_selected.label')}"/></span><s:submit
