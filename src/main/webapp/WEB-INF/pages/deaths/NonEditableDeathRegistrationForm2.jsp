    ...
    <table border="1" style="width: 100%; border:1px solid #000; border-collapse:collapse;"
        ...
        <tr>
            ...
            <td colspan="3"><s:label
                    value="%{#session.deathRegister.certifyingAuthority.certifyingAuthorityPIN}"/></td>
            </td>
        </tr>
        <tr>
            <td colspan="1">නම<br>கொடுப்பவரின் பெயர்<br>Name</td>
            <td colspan="3"><s:label
                    value="%{#session.deathRegister.certifyingAuthority.certifyingAuthorityName}"/></td>
        </tr>
        <tr>
            <td colspan="1">තැපැල් ලිපිනය<br>தபால் முகவரி<br>Postal Address</td>
            <td colspan="3"><s:label
                    value="%{#session.deathRegister.certifyingAuthority.certifyingAuthorityAddress}"/></td>
        </tr>
        <tr>
            <td>දිනය<br>திகதி<br>Date</td>
            <td colspan="4"><s:label
                    value="%{#session.deathRegister.certifyingAuthority.certifyingAuthoritySignDate}"/></td>
        </tr>
        </tbody>
    </table>
</s:if>
