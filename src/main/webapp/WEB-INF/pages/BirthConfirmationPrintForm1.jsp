    ...
    <s:form action="eprBirthConfirmationPrint" name="birthConfirmationPrintForm1" id="birth-confirmation-print-form-1"
        ...
        <div id="brf-serial-no-and-date" class="font-9">
            ...
            <s:textfield cssClass="disable" disabled="true"
                         value="%{#session.birthRegister.register.dateOfRegistration}"/>
        </div>
        ...
        <div id="bcf-dob" class="font-9">
            ...
            <div class="current-print">
                <div id="current-year" class="font-7">
                    ...
                    <s:textfield value="%{#session.birthRegister.child.dateOfBirth.year + 1900}" cssClass="disable"
                                 disabled="true"/>
                </div>
                <div id="current-month" class="font-7">
                    <label>*in Sinhala<br>*in Tamil<br>Day</label>
                    <s:textfield value="%{#session.birthRegister.child.dateOfBirth.month + 1}" cssClass="disable"
                                 disabled="true"/>
                </div>
                <div id="current-day" class="font-7">
                    <label>*in Sinhala<br>*in Tamil<br>Day</label>
                    <s:textfield value="%{#session.birthRegister.child.dateOfBirth.date}" cssClass="disable"
                                 disabled="true"/>
                </div>
            </div>
            <div class="new">
        ...
        <div id="bcf-gender" class="font-9">
            ...
            <div class="current-print">
                <% switch (((BirthDeclaration) (session.getAttribute("birthRegister"))).getChild().getChildGender()) {
                    case 0:%>
        ...
        <div id="bcf-district" class="font-9">
            ...
            <div class="current-print">
                <s:textfield value="%{#session.birthRegister.register.birthDivision.dsDivision.district.siDistrictName}"
        ...
        <div id="bcf-ds-division" class="font-9">
            ...
            <div class="current-print">
                <s:textfield value="%{#session.birthRegister.register.birthDivision.dsDivision.siDivisionName}"
                             cssClass="disable" disabled="true"/>
            </div>
        ...
        <div id="bcf-division" class="font-9">
            ...
            <div class="current-print">
                <s:textfield value="%{#session.birthRegister.register.birthDivision.siDivisionName}" cssClass="disable"
                             disabled="true"/>
            </div>
        </div>
        ...
        <div id="bcf-father-pin" class="font-9">
            ...
            <div class="current-print">
                <s:textfield value="%{#session.birthRegister.parent.fatherNICorPIN}" cssClass="disable"
                             disabled="true"/>
            </div>
        </div>
        <div id="bcf-father-race" class="font-9">
            ...
            <div class="current-print">
                <s:textfield value="%{#session.birthRegister.parent.fatherRace.siRaceName}" cssClass="disable"
                             disabled="true"/>
            </div>
        </div>
        <div id="bcf-mother-pin" class="font-9">
            ...
            <div class="current-print">
                <s:textfield value="%{#session.birthRegister.parent.motherNICorPIN}" cssClass="disable"
                             disabled="true"/>
            </div>
        </div>
        <div id="bcf-mother-race" class="font-9">
            ...
            <div class="current-print">
                <s:textfield value="%{#session.birthRegister.parent.motherRace.siRaceName}" cssClass="disable"
                             disabled="true"/>
            </div>
        </div>
        <div id="bcf-marital-status" class="font-9">
            ...
            <div class="current-print">
                <s:textfield value="%{getText('married.status.'+#session.birthRegister.marriage.parentsMarried)}"
