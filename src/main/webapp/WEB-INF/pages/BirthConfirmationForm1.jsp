...
<s:form action="eprBirthConfirmation_birthConfirmationPreProcessor.do" method="POST">
    <div id="birth-confirmation-form-1-body">
        ...
        <div id="birth-confirmation-birth-place">
            <s:textfield name="birthRegister.childBirthPlace"/>
        ...
        <div id="birth-confirmation-name"><s:textarea name="birthRegister.childFullNameOfficialLang" cols="38" rows="7" /></div>
        <div id="birth-confirmation-name-in-english"><s:textarea name="birthRegister.childFullNameEnglish" cols="38" rows="5"/></div>
        <div id="birth-confirmation-gender">
            <s:select list="{'Male','Female'}" name="birthRegister.childGender" headerKey="0" headerValue="-Select Gender-"/>
        </div>
