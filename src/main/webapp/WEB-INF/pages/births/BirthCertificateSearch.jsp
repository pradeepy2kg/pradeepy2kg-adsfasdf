...
<script>
    ...
    function validate() {
        ...
        if (isFieldEmpty(domObject))
            isEmpty(domObject, 'error1', 'error3');
        else
...
<s:form action="eprBirthCertificateSearch.do" name="birthCertificateSearchForm" id="birth-certificate-search-form-1"
    ...
    <table style="font-size:9pt">
        ...
        <tr>
            <td colspan="8">
                උපත සිදුවූ දිස්ත්‍රික්කයේ දිස්ත්‍රික් රෙජිස්ට්‍රාර් වෙත යැවිය යුතුය.
                <br>* Tamil
    ...
    <table class="table_reg_page_01" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td class="font-9"><label>(2) ඉල්ලුම්කරන්නේ කාගේ උප්පැන්නය ගැනද? <br>එම අයගේ සම්පූර්ණ නම රාජ්‍ය භාෂාවෙන්
                (සිංහල / දෙමළ)<br>*Tamil<br>
                Full Name of the person respecting whose birth application is made (Sinhala/Tamil) ?
            </label></td>
            <td colspan="6"><s:textarea name="bcSearch.childFullNameOfficialLang" id="childFullNameOfficialLang"
                                        cssStyle="text-transform:uppercase;"/></td>
        </tr>
        <tr>
            <td class="font-9"><label> ඉල්ලුම්කරන්නේ කාගේ උප්පැන්නය ගැනද? <br>එම අයගේ සම්පූර්ණ නම ඉංග්‍රීසි භාෂාවෙන්
                <br>*Tamil<br>
        ...
        <tr>
            ...
            <td colspan="3"><s:textfield name="" id=""/></td>
        </tr>
        </tbody>
    </table>
