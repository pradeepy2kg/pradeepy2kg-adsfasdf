...
<table class="table_reg_page_01" cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <td colspan="6" class="table_reg_cell_01" id="table_reg_cell_01">
            <s:label value="%{#session.birthRegister.register.birthDivision.dsDivision.siDivisionName}" cssStyle="float:left;  width:240px;"/>
        </td>
    <tr>
    ...
    <tr>
        ...
        <td><s:if test="session.birthRegister.child.birthAtHospital ==true">
    ...
    <tr>
        ...
        <td colspan="6"><s:label value="%{#session.birthRegister.register.preferredLanguage}"  cssStyle="width:190px; margin-left:5px;"/></td>
    </tr>
    <tr>
        ...
        <td colspan="2"><s:label value="%{#session.birthRegister.child.childBirthWeight}" cssStyle="width:95%;"/></td>
    </tr>
    <tr>
        ...
        <td colspan="2"><s:label value="%{#session.birthRegister.child.numberOfChildrenBorn}" cssStyle="width:95%;"/></td>
    </tr>
