...
<fieldset style="margin-bottom:10px;margin-top:20px; border:none">
    ...
    <table width="100%" cellpadding="5" cellspacing="0">
        ...
        <tr>
            ...
            <td align="right"><s:label value="%{getText('date.from.label')}" cssStyle=" margin-right:5px;"/><sx:datetimepicker name="searchStartDate"
                                                                                                 displayFormat="yyyy-MM-dd"/></td>
            <td align="right"><s:label value="%{getText('date.to.label')}" cssStyle=" margin-right:5px;"/><sx:datetimepicker name="searchEndDate"
                                                                                               displayFormat="yyyy-MM-dd"/></td>
        </tr>
        <tr>
