...
<script>
    ...
    function setValuesEmpty() {
        document.getElementById('bdfSerialNoId1').value = null;
        document.getElementById('bdfSerialNoId2').value = null;
    }
</script>
...
<script>
    ...
    function validateForm() {
        ...
        if (domObject.value != "") {
            validateNumber(domObject.value, 'invalideDateErr', 'confSerialNumber');
        }
        if (errormsg != "") {
            alert(errormsg)
            errormsg = "";
...
<div>
    ...
    <s:if test="#request.bdf != null || #request.searchResultList.size>0">
        <fieldset style="margin-bottom:10px;margin-top:20px;border:2px solid #c3dcee;">
            ...
            <table id="search-list-table" width="100%" cellpadding="0" cellspacing="0" class="display"  style="font-size:10pt;">
                <thead>
                <tr>
                ...
                <s:if test="%{#request.bdf != null}">
                    <tr>
                        <td><s:property value="bdf.register.birthDivision.divisionId"/></td>
